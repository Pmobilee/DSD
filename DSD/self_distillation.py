                        ...
                        for i, class_prompt in enumerate(tepoch):
                            ...
                            if session != None and generation > 0 and generation % 5 == 0: # or instance==1:
                                    ...
                                    with torch.no_grad():
                                        ...
                                        images, _ = util.compare_teacher_student_x0(original, sampler_original, student, sampler_student, steps=[16, 8,  4, 1], prompt=992)
                                        ...
                                        images, _ = util.compare_teacher_student(original, sampler_original, student, sampler_student, steps=[16, 8,  4, 1], prompt=992)
                                        images = wandb.Image(_, caption="left: Teacher, right: Student")
